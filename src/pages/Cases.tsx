...
const Cases = () => {
  const sectionConfig = navigationConfig.sections.cases;
  const { posts: casesPosts, loading, error } = usePostsByCategory(sectionConfig.category);
      ...
      <div className="container mx-auto py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8">
          {showSkeleton ? (
            ...
            <p className="col-span-12 text-text-secondary text-base sm:text-lg">The {sectionConfig.name.toLowerCase()} collection is being curated. Check back soon!</p>
          )}
        </div>
      </div>
    </>
