...
const Hindsight = () => {
  const { posts: hindsightPosts, loading, error } = usePostsByCategory('Hindsight');
      ...
      <div className="container mx-auto py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8">
          {showSkeleton ? (
            ...
            <p className="col-span-12 text-red-500 text-base sm:text-lg">Error loading hindsight posts: {error}</p>
            ...
            <p className="col-span-12 text-text-secondary text-base sm:text-lg">No hindsight articles have been posted yet. Check back soon!</p>
          )}
        </div>
      </div>
    </>
